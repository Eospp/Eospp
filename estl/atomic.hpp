...
public:
    ...
    bool compare_exchange_weak(value_type &expect,value_type v,memory_order m1,memory_order m2) noexcept
    {
        return __atomic_compare_exchange_n(&value_,&expect,v,1,static_cast<int>(m1),static_cast<int>(m2));
    }
    
    bool compare_exchange_weak(value_type &expect,value_type v,memory_order m1,memory_order m2) volatile noexcept
    {
        return __atomic_compare_exchange_n(&value_,&expect,v,1,static_cast<int>(m1),static_cast<int>(m2));
    }
    
    bool compare_exchange_strong(value_type &expect,value_type v,memory_order m1,memory_order m2) volatile noexcept
    {
        return __atomic_compare_exchange_n(&value_,&expect,v,0,static_cast<int>(m1),static_cast<int>(m2));
    }
    
    bool compare_exchange_strong(value_type &expect,value_type v,memory_order m1,memory_order m2) noexcept
    {
        return __atomic_compare_exchange_n(&value_,&expect,v,0,static_cast<int>(m1),static_cast<int>(m2));
    }
...
public:
    ...
    bool compare_exchange_weak(bool& expect, bool v, memory_order m1,memory_order m2) volatile noexcept
    { 
        return value_.compare_exchange_weak(expect, v, m1, m2); 
    }
    ...
    bool compare_exchange_strong(bool& expect, bool v, memory_order m1, memory_order m2) volatile noexcept
    { 
        return value_.compare_exchange_strong(expect, v, m1, m2); 
    }
